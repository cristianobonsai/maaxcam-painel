    ...
    <header className="reveal reveal-1 sticky top-0 z-30 border-b border-slate-800/60 backdrop-blur-xl bg-slate-950/40">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
        ...
        <div className="flex items-center gap-3">
          <button className="hidden rounded-md border border-slate-600 px-4 py-2 text-sm font-medium text-slate-300 transition-colors hover:border-blue-500 hover:text-white sm:block">
            Entrar
          </button>
          <button className="rounded-md bg-blue-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition-colors hover:bg-blue-600">
            Criar conta
          </button>
        </div>
      </nav>
